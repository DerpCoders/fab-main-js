...
module.exports = {
    ...
    execute(message, args){
        if (message.channel.type === 'text'){
            const punchUser = message.mentions.members.first()
        ...
        title = 'ouch! xD';
            ...
            url1 = 'https://i.chzbgr.com/full/8583163648/h2396FC8A/screw-you-power-star.gif';
        origin = 'Source: Cheezburger.com';
        title = 'oof!';
        }else if(random == 4){
            url1 = 'https://media1.tenor.com/images/31686440e805309d34e94219e4bedac1/tenor.gif?itemid=4790446';
        origin = 'Source: Tenor ';
        title = 'oof!';
        }else if(random = 5){
            url1 = 'https://media1.tenor.com/images/6834932465e2659dc5b1ee38dfd42b44/tenor.gif?itemid=14615839';
        origin = 'Source: Tenor';
        title = 'oof!';
        }else if(random == 6){
