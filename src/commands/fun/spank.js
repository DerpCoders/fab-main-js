...
module.exports = {
  ...
  execute(message, args) {
    const spUser = message.mentions.members.last();
    ...
    if (random == 0) {
      ...
      origin =
        "Source: Tenor | Due to NSFW content there are no anime gifs for this command.";
      title = "xD";
      ...
      url1 =
        "https://i.pinimg.com/originals/ea/fb/13/eafb13b900645ddf3b30cf9cc28e9f91.gif";
      origin =
        "Source: Pinterest | Due to NSFW content there are no anime gifs for this command.";
      title = "LOL";
      footer =
        "https://i.pinimg.com/originals/d3/d1/75/d3d175e560ae133f1ed5cd4ec173751a.png";
    } else if (random == 3) {
      url1 =
        "https://pa1.narvii.com/6079/b1e5e91c2aa7da179b8b5c4f821fe50f7516fea3_hq.gif";
